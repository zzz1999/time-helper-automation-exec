...
public class SignAutomation {
    ...
    private static final int ERROR_TERMINATION_TIME = 2;
    ...
    public static void init() {
        ...
        try {
            ...
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "USERNAME=13757700166"}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "PASSWORD=Aa123456"}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "APP_ID=pneumonia"}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "SCKEY=SCT105154TXacTcfGbUP2AQ5ivyzlG0nlu"}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "MSG_KEY=SCT105154TXacTcfGbUP2AQ5ivyzlG0nlu"}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "MSG_URL=https://sctapi.ftqq.com/SCT105154TXacTcfGbUP2AQ5ivyzlG0nlu.send?title=%E4%B8%BB%E4%BA%BA%EF%BC%8C%E8%A6%81%E6%89%93%E5%8D%A1%E4%BA%86%E5%96%B5%E2%9D%A4&desp=%E6%AD%A3%E5%9C%A8%E5%B0%9D%E8%AF%95%E6%89%93%E5%8D%A1..."}, null, null);
            //runtime.exec(new String[]{"/bin/sh", "-c", "export", "TEXT_OK=呐,主人!打卡成功了喵❤"}, null, null);
    ...
    public static boolean sign() {
        ...
        try {
            Runtime runtime = Runtime.getRuntime();
            Process process = runtime.exec(new String[]{"/bin/sh", "-c", "node dist/tools/main.js > logs/" + LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy年MM月dd日HH时mm分ss秒打卡记录")) + ".txt"}); // TODO 没有log
